...
class ModeloComercio{
	...
	static public function mdlActualizarInformacion($tabla, $id, $datos){
		...
		modoPaypal = :modoPaypal, clienteIdPaypal = :clienteIdPaypal, llaveSecretaPaypal = :llaveSecretaPaypal, modoPayu = :modoPayu, merchantIdPayu = :merchantIdPayu, accountIdPayu = :accountIdPayu, apiKeyPayu = :apiKeyPayu, modoCulqi = :modoCulqi, publicKeyCulqi = :publicKeyCulqi, secretKeyCulqi = :secretKeyCulqi, divisa = :divisa WHERE id = :id");
		...
		$stmt->bindParam(":modoCulqi", $datos["modoCulqi"], PDO::PARAM_STR); 
		$stmt->bindParam(":publicKeyCulqi", $datos["publicKeyCulqi"], PDO::PARAM_STR); 
		$stmt->bindParam(":secretKeyCulqi", $datos["secretKeyCulqi"], PDO::PARAM_STR);
		$stmt->bindParam(":id", $id, PDO::PARAM_INT);

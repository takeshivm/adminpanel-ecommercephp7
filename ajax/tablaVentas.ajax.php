...
class TablaVentas{
  ...
  public function mostrarTabla(){	
	...
	for($i = 0; $i < count($ventas); $i++){
		...
		}else if($ventas[$i]["metodo"] == "culqi"){

			$metodo = "<img class='img-responsive' src='vistas/img/plantilla/culqi.jpeg' width='300px'>";
		...
		$verDetalle = "<button class='btn btn-warning btnVerDetalle' idVenta='".$ventas[$i]["id_venta"]."' onclick='verDetalleVenta(".$ventas[$i]["id_venta"].")'>Ver detalle</button>";

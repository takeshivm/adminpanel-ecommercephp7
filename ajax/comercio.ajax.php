...
class AjaxComercio{
	...
	public $apiKeyPayu;
	public $modoCulqi;
	public $publicKeyCulqi;
	public $secretKeyCulqi;
	...
	public function ajaxCambiarInformacion(){
		...
		$datos = array("impuesto"=>$this->impuesto,
						...
						"modoCulqi"=>$this->modoCulqi,
						"publicKeyCulqi"=>$this->publicKeyCulqi,
						"secretKeyCulqi"=>$this->secretKeyCulqi);
...
if(isset($_POST["impuesto"])){
	...
	$informacion -> modoCulqi = $_POST["modoCulqi"];
	$informacion -> publicKeyCulqi = $_POST["publicKeyCulqi"];
	$informacion -> secretKeyCulqi = $_POST["secretKeyCulqi"];

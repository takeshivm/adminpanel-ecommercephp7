...
<div class="box box-info">
	...
	<div class="box-body formularioInformacion">
		...
		<div class="form-group">
	      ...
	      <label for="sel1">Divisa del comercio:</label>

	      <input type="hidden" id="codigoDivisa" value="<?php echo $comercio["divisa"]; ?>">
			...
			<div class="panel-body">
				...
				<div class="form-group row">
					 ...
					 <div class="col-xs-3">
						...
						<label>Modo:</label>
						 ...
						 <?php
      					...
      					if($comercio["modoCulqi"] == "sandbox"){

      						echo '	<label class="checkbox">

      									<input class="cambioInformacion" type="radio" value="sandbox" name="modoCulqi" checked>  
          							...
          							<label class="checkbox">
          								...
          								<input class="cambioInformacion" type="radio" value="live" name="modoCulqi"> 
      						...
      						echo '	<label class="checkbox">
      									...
      									<input class="cambioInformacion" type="radio" value="sandbox" name="modoCulqi">  
          							...
          							<label class="checkbox">
          								...
          								<input class="cambioInformacion" type="radio" value="live" name="modoCulqi" checked> 
					 ...
					 <div class="col-xs-4">
            			...
            			<input type="text" class="form-control cambioInformacion" id="publicKeyCulqi" value="<?php echo $comercio["publicKeyCulqi"]; ?>">
      			 	...
      			 	<div class="col-xs-5">
		            	...
		            	<input type="text" class="form-control cambioInformacion" id="secretKeyCulqi" value="<?php echo $comercio["secretKeyCulqi"]; ?>">

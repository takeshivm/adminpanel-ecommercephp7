          ...
          <div class="box-body">
           ...
           <!--=====================================
            ...
            <div class="detallesFisicos" style="display:none">
              ...
              <div class="form-group row" style="display: none">
                ...
                <div class="col-xs-3">
                  <input class="form-control input-lg" type="text" value="Tamaño" readonly>
                </div>

                <div class="col-xs-9">
                    <input class="form-control input-lg tagsInput detalleTamano" data-role="tagsinput" type="text" placeholder="Separe valores con coma">
                </div>
              ...
              <div class="form-group row" style="display: none">
                ...
                <div class="col-xs-3">
                  <input class="form-control input-lg" type="text" value="Tipo" readonly>
                </div>

                <div class="col-xs-9">
                    <input class="form-control input-lg tagsInput detalleTipo" data-role="tagsinput" type="text" placeholder="Separe valores con coma">
                </div>
              ...
              <div class="form-group row" style="display: none">
                ...
                <div class="col-xs-3">
                  <input class="form-control input-lg" type="text" value="Capacidad" readonly>
                </div>

                <div class="col-xs-9">
                    <input class="form-control input-lg tagsInput detalleCapacidad" data-role="tagsinput" type="text" placeholder="Separe valores con coma">
                </div>
           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <img src="vistas/img/cabeceras/default/defaultp-s.jpg" class="img-thumbnail previsualizarPortada" width="100%">
            ...
            <!--=====================================
            AGREGAR STOCK Y CODIGO (SI LO HUBIERA)
            ======================================-->
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg stock" value="0" min="0" step="any" required>
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="panel">CODIGO</div>
              
                <div class="input-group">
              
                  <span class="input-group-addon"><i class="fa fa-key"></i></span> 

                  <input type="text" class="form-control input-lg codigo" min="0" maxlength="50">
           ...
           <!--=====================================
            ...
            <div class="detallesFisicos" style="display:none">
              ...
              <div class="form-group row" style="display: none">
                ...
                <div class="col-xs-9 editarTamano">
                    <!--   <input class="form-control input-lg tagsInput detalleTamano" data-role="tagsinput" type="text" placeholder="Separe valores con coma"> -->
                </div>
              ...
              <div class="form-group row" style="display: none">
                ...
                <div class="col-xs-9 editarCapacidad">
                    <!--   <input class="form-control input-lg tagsInput detalleCapacidad" data-role="tagsinput" type="text" placeholder="Separe valores con coma"> -->
                </div>

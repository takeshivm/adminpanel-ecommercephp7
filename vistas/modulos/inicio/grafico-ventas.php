...
foreach ($ventas as $key => $value) {
	...
	/*=============================================
  	...
  	=============================================*/
  	if($value["metodo"] == "culqi"){

  		 $totalCulqi += $value["pago"];

  		 $porcentajeCulqi = $totalCulqi * 100 / $totalVentas["total"];
  	}
  	...
  	<div class="box-footer no-border">
	    ...
	    <div class="row">
	      ...
	      <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
	        ...
	        <input type="text" class="knob" data-readonly="true" value="<?php echo round($porcentajeCulqi); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">

	        <div class="knob-label">Culqi</div>

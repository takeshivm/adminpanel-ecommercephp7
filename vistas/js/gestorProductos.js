...
function agregarMiProducto(imagen){
	    ...
	    if(seleccionarTipo == "virtual"){
			...
			var detalles = {"Talla": $(".detalleTalla").tagsinput('items'),
			       			...
			       			"Tamano": $(".detalleTamano").tagsinput('items'),
			       			"Tipo": $(".detalleTipo").tagsinput('items'),
			       			"Capacidad": $(".detalleCapacidad").tagsinput('items')
			       			};
		...
		success: function(respuesta){
			...
			=============================================*/
				...
				$(".editarTalla").html(
					...
					'<input class="form-control input-lg tagsInput detalleTalla" value="'+
					(detalles.Talla != "" && detalles.Talla != "undefined" ? detalles.Talla : "")
				...
				$(".editarColor").html(
					...
					'<input class="form-control input-lg tagsInput detalleColor" value="'+
					(detalles.Color != "" && detalles.Color != "undefined" ? detalles.Color : "")
					+'" data-role="tagsinput" type="text" style="padding:20px">'
				...
				$(".editarMarca").html(
					...
					'<input class="form-control input-lg tagsInput detalleMarca" value="'+
					(detalles.Marca != "" && detalles.Marca != "undefined" ? detalles.Marca : "")
					+'" data-role="tagsinput" type="text" style="padding:20px">'
				...
				$(".editarTipo").html(
					...
					'<input class="form-control input-lg tagsInput detalleTipo" value="'+
					(detalles.Tipo != "" && detalles.Tipo != "undefined" ? detalles.Tipo : "")
					+'" data-role="tagsinput" type="text" style="padding:20px">'

				)

				$("#modalEditarProducto .detalleTipo").tagsinput('items');

				$(".editarTamano").html(

					'<input class="form-control input-lg tagsInput detalleTamano" value="'+
					(detalles.Tamano != "" && detalles.Tamano != "undefined" ? detalles.Tamano : "")
					+'" data-role="tagsinput" type="text" style="padding:20px">'

				)

				$("#modalEditarProducto .detalleTamano").tagsinput('items');

				$(".editarCapacidad").html(

					'<input class="form-control input-lg tagsInput detalleCapacidad" value="'+
					(detalles.Capacidad != "" && detalles.Capacidad != "undefined" ? detalles.Capacidad : "")
					+'" data-role="tagsinput" type="text" style="padding:20px">'

				)

				$("#modalEditarProducto .detalleCapacidad").tagsinput('items');
			...
			/*=============================================
			CARGAMOS EL PRECIO, PESO, DIAS DE ENTREGA, STOCK y CÓDIGO
			=============================================*/
			...
			$("#modalEditarProducto .codigo").val(respuesta[0]["codigo"]);
...
function editarMiProducto(imagen){
	...
	var codigo = $("#modalEditarProducto .codigo").val();
  	...
  	if(seleccionarTipo == "virtual"){
		...
		var detalles = {"Talla": $("#modalEditarProducto .detalleTalla").tagsinput('items'),							
		       			...
		       			"Tipo": $("#modalEditarProducto .detalleTipo").tagsinput('items'),
		       			"Tamano": $("#modalEditarProducto .detalleTamano").tagsinput('items'),
		       			"Capacidad": $("#modalEditarProducto .detalleCapacidad").tagsinput('items'),
		       		};

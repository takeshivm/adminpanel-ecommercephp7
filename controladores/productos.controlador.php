...
class ControladorProductos{
	...
	static public function ctrMostrarSumaCompras(){
		...
		//SUMAMOS LA CANTIDAD DE TODOS LOS DETALLES DE COMPRA PARA
		//SABER EL TOTAL DE TODAS LAS COMPRAS
	...
	/*=============================================
	MOSTRAR PRODUCTOS POR ORDEN
	=============================================*/

	static public function ctrMostrarProductosOrden($item, $valor, $orden){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlMostrarProductosOrden($tabla, $item, $valor, $orden);
	...
	static public function ctrEditarProducto($datos){
		...
		if(isset($datos["idProducto"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $datos["tituloProducto"])  && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descripcionProducto"]) ){
				...
				if (isset($datosProducto["idCabecera"]) && $datosProducto["idCabecera"] != null) {
